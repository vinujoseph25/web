...
#
babbleApp.controller 'PushDashboardController', ($scope, $uibModalInstance, $q, $http, $timeout, analyticsService, configService, dashboardService, focusService, userService) ->

    $scope.environmentsForPush = _.reject configService.babbleEnvironments, { canPush: false }
