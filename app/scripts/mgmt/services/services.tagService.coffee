...
babbleServices.factory 'tagService', ($http, configService) ->

    {
        ...
        getTags: (callback) ->
            ...
            q.error -> alertify.error 'Cannot connect to babble-service (getTags)', 2500
        ...
        getSearchHints: (callback) ->
            ...
            q.error -> alertify.error 'Cannot connect to babble-service (getSearchHints)', 2500
    }
