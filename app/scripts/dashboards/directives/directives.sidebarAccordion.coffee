...
babbleDirectives.directive 'sidebarAccordion', ($sce, $timeout) ->
    {
        restrict: 'EAC'
...
babbleDirectives.directive 'accordionGroup', ->
    {
...
babbleDirectives.directive 'accordionHeading', ->
    {
        restrict: 'EA'
        transclude: true   
        template: ''       
...
babbleDirectives.directive 'accordionTransclude', ->
    {
        require: '^accordionGroup'
