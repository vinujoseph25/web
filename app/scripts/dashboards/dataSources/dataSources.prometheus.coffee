...
#
# Queries Prometheus API for metrics.  Always proxies requests through the Babble service.
#
babbleDataSources.factory 'prometheusDataSource', ($q, $http, configService, dataSourceFactory) ->
    ...
    runner = (options) ->
        ...
        successCallback = (result) ->
            ...
            # Translate from Prometheus JSON format to Babble format
