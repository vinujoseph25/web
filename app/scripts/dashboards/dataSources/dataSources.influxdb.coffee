...
#
# Queries InfluxDB API for metrics.  Always proxies requests through the Babble service.
#
babbleDataSources.factory 'influxdbDataSource', ($q, $http, configService, dataSourceFactory) ->
    ...
    runner = (options) ->
        ...
        successCallback = (result) ->
            ...
            # Translate from InfluxDB JSON format to Babble format
