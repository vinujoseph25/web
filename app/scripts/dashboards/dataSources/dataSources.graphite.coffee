...
#
# Queries Graphite API for metrics.  Always proxies requests through the Babble service.
#
babbleDataSources.factory 'graphiteDataSource', ($q, $http, configService, dataSourceFactory) ->
    ...
    runner = (options) ->
        ...
        successCallback = (result) ->
            ...
            # Translate from Graphite JSON format to Babble format
