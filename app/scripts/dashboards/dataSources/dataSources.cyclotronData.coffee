...
#
# BabbleData Data Source
#
# Retrieves data from a BabbleData bucket.  Does not use a proxy. 
#
babbleDataSources.factory 'babbledataDataSource', ($q, $http, configService, dataSourceFactory) ->
    ...
    dataSourceFactory.create 'BabbleData', runner
