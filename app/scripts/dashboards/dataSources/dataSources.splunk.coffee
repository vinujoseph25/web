...
# Splunk Data Source
#
# Runs a Splunk job. Always proxies requests through the Babble service.
#
# Properties:
...
#
babbleDataSources.factory 'splunkDataSource', ($q, $http, configService, dataSourceFactory, logService) ->
    ...
    runner = (options) ->
        ...
        successCallback = (proxyResult) ->
            ...
            if !_.isEmpty results
                ...
                # Translate from Splunk JSON_rows format to Babble format
