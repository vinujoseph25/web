...
# Implements a limited but useful subset of functionality and attempts to parse the results into Babble's format.
# For more control, the JSON Data Source should be used directly.
#
# Always proxies requests through the Babble service.
#
babbleDataSources.factory 'elasticsearchDataSource', ($q, $http, configService, dataSourceFactory, logService) ->
    ...
    # Converts Elasticsearch aggregations response to Babble format
