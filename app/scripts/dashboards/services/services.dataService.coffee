...
#
#     babbleApp.controller 'SampleWidget', [
#         '$scope', 'dataService', 
#         ($scope, dataService) ->
# 
...
#
babbleServices.factory 'dataService', ($injector, configService) ->
    ...
    return {
        ...
        get: (dataSourceDefinition) -> 
            ...
            if not Babble.dataSources[name]?
                ...
                # Set options
                Babble.dataSources[name] = dataSource.initialize(dataSourceDefinition)

            # Return from cache
            return Babble.dataSources[name]
