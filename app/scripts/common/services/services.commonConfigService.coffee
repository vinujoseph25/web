...
babbleServices.factory 'commonConfigService', ->
    ...
    exports = {
        ...
        newUser:
            enableMessage: false
            welcomeMessage: 'It looks like you\'re new here! <h6>Welcome to Babble</h6>'
            iconClass: 'fa-info'
            autoDecayDuration: 1
        ...
        dashboard:
            properties:
                ...
                autoRotate:
                    label: 'Auto-Rotate'
                    description: 'If set to true, Babble will automatically rotate between pages of the Dashboard based on the duration property for each Page. Set this value false to require manual rotation.'
                    type: 'boolean'
                    default: false
                    required: false
                    defaultHidden: true
                ...
                dataSources:
                    ...
                    properties:
                        ...
                        preload:
                            label: 'Preload'
                            description: 'By default, each Data Source is loaded only when it is used, e.g. when a Widget consuming it is rendered. Setting this true causes Babble to load the Data Source when the Dashboard is initialized.'
                            type: 'boolean'
                            inlineJs: false
                            required: false
                            default: false
                    ...
                    options:
                        ...
                        babbleData:
                            ...
                            label: 'BabbleData'
                            icon: 'fa-cloud-download'
                            message: 'Babble has built-in support for a limited amount of data storage using uniquely-named buckets.  Refer to to the Documentation for more details.'
                            properties:
                                key:
                                    label: 'Bucket Key'
                                    description: 'Specifies the unique key to a Babble Data bucket.'
                                ...
                                url:
                                    label: 'Babble Server'
                                    description: 'Specifies which Babble server to request data from. If omitted, the default sever will be used.'
                                    type: 'url'
                                    inlineJs: true
                                    required: false
                                    defaultHidden: true
                        ...
                        elasticsearch:
                            ...
                            properties:
                                ...
                                responseAdapter:
                                    ...
                                    description: 'Determines how the Elasticsearch response will be converted to Babble\'s data format.  Defaults to "auto".'
                                    type: 'string'
                                    default: 'auto'
                                    inlineJs: true
                                    options:
        ...
        help: [
            {
                ...
                children: [
                    ...
                    {
                        name: 'BabbleData'
                        path: '/partials/help/babbledata.html'
                        tags: ['babbledata', 'data', 'storage', 'bucket', 'api']
                    }
                    {
        ...
        widgets:
            annotationChart:
                ...
                properties:
                    ...
                    annotationEditing:
                        ...
                        description: 'Optional, but if enabled, allows users to create new annotations for points on the chart.  Annotations are stored automatically within Babble.'
                        type: 'boolean'
                        required: false
                        default: false
                        order: 13
                    annotationKey:
                        ...
                        description: 'Provides a BabbleData bucket key to be used for built-in annotation editing. This property is automatically initialized with a random UUID.'
                        type: 'string'
                        inlineJs: true
                        required: false
                        defaultHidden: true
            ...
            javascript:
                ...
                properties:
                    ...
                    functionName:
                        label: 'Function Name'
                        description: 'JavaScript function name used to create a controller instance. Supports namespaces/drilldown using periods, e.g. Babble.functions.scatterPlot'
