...
babbleServices.factory 'analyticsService', ($http, $q, $localForage, $location, configService, logService, userService) ->
    ...
    analyticsHelper = (name, endpoint, dashboardId, startDate, endDate) ->
        ...
        .catch (error) ->
            alertify.error 'Cannot connect to babble-service (' + name + ')', 2500
    ...
    exports = {
        ...
        getStatistics: ->
            ...
            .then (result) ->
                result.data
            .catch (error) ->
                alertify.error 'Cannot connect to babble-service (getStatistics)', 2500
    }
